(function (a) {
	...
	a.fn.modalPopLite = function (c) {
		...
		, {
			openButton: "modalPopLite-open-btn", closeButton: "modalPopLite-close-btn", isModal: false, callBack: null
		}
		, c);
		return this.each(function () {
			...
			a(triggerObj).live("click", function (b) {
				...
				a("#modalPopLite-mask" + d).css("height", "100%");
				...
				if(a("#modalPopLite-wrapper" + d).css('top') == '' ) {
					a("#modalPopLite-wrapper" + d).css({top:j});
				}

				a("#modalPopLite-wrapper" + d).fadeIn("slow");
				a("#modalPopLite-wrapper" + d).css('position','absolute');
				a("#modalPopLite-wrapper" + d + " div:first-child").css('position','absolute');
				e = true
			}
			);
