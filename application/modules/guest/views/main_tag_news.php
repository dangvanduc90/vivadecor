                    ...
                    <div class="col-xs-12 pad-btm">
                        <div class="row">
                            ...
                            <div class="col-md-3 hidden-xs hidden-sm">
                                ...
                                <?php foreach ($news_cate as $n_c) { ?>
                                    <div class="media news longer">
                                        <div class="media-body">
                                            <a href="<?= base_url() . 'tin-tuc/' . $n_c -> Slug ?>">
                                                <h4 class="media-heading longer"><i class="fa fa-angle-right hidden-lg hidden-md">&nbsp;</i><?= $n_c -> Title ?></h4>
                                            </a>
                                        </div>
                                    </div>
                                <?php } ?>
