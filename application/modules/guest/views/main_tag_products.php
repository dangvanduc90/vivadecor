											...
											<div class="thumbnail products">
												...
												<div class="caption">
													...
													<?php if ($pL -> SellPrice > 0) { ?>
														<span class="new-price"><?= number_format($pL -> SellPrice,0,".",".") . " đ" ?></span>
													<?php } else { ?>
														<span class="new-price">Liên hệ</span>
													<?php } ?>
													<span class="old-price"><?php if ($pL -> ListPrice > 0) echo number_format($pL -> ListPrice,0,".",".") . " đ"; ?></span>
												</div>
											</div>
										</div>
									<?php }} ?>
