				...
				<div class="col-xs-12">
					...
					<div class="du-an-home-item block items">
						...
						<?php for ($i=1; $i <= $total_page; $i++) { ?>
							<li <?php if ($i == $current_page) {echo 'class="active"';} ?> ><a rel="nofollow" href="javascript:;" data-page="<?= $i; ?>" ><?= $i; ?></a></li>
						<?php } ?>
				...
				<div class="col-xs-12">
					...
					<div class="du-an-home-item block items">
						...
						<h3>
							...
							<strong>Dự án mới cập nhật</strong>
	        ...
	        success: function(obj) {
					...
					for(var index in obj) {
							...
							strhtml += '<div class="hover">';
								strhtml += '<div class="inner"><span><a class="title " href="<?= base_url();?>'+obj[index].Slug+'.html'+ ' " rel="nofollow ">Xem chi tiết</a></span></div>';
							strhtml += '</div>';
