        ...
        private function Categories_search($parentid = 0,$array = array()){
            ...
            if(count($temp) > 0) {
                ...
                for ($i=0; $i < count($temp); $i++) {
                    ...
                    $categories .= '<div class="form-item form-type-radio form-item-mausac">';

                    $categories .= '<input type="checkbox" name="mausac[]" id="edit-mausac-'.$temp[$i]['SortingBrandID'].'" value="'.$temp[$i]['SortingBrandID'].'" class="form-radio" />';

                    $categories .= '<label class="option" for="edit-mausac-'.$temp[$i]['SortingBrandID'].'">'.$temp[$i]["Title"].'</label>';
