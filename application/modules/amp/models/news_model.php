	...
	class News_model extends Cms_Base_model {
        ...
        function Get_child_news($ParentID,$limit = 0,$start = 0) {
            ...
            if ($lang == 'en'){
                ...
                $this -> db -> select('news.Title_en as Title,news.Description_en as Description,Slug,ImageURL,ImagePreset,ImageTitle,ImageAlt,CreatedDate');

            } else if ($lang == 'fr'){

                $this -> db -> select('news.Title_fr as Title,news.Description_fr as Description,Slug,ImageURL,ImagePreset,ImageTitle,ImageAlt,CreatedDate');

            } else {

                $this -> db -> select('news.Title,news.Description,Slug,ImageURL,ImagePreset,ImageTitle,ImageAlt,CreatedDate');
        ...
        function Get_latest_news($limit = 0,$start = 0){
            ...
            if ($lang == 'en'){
                ...
                $this -> db -> select('news.Title_en as Title,news.Description_en as Description,news.Slug,news.ImageURL,news.ImagePreset,news.ImageTitle,news.ImageAlt,news.CreatedDate');

            } else if ($lang == 'fr'){

                $this -> db -> select('news.Title_fr as Title,news.Description_fr as Description,news.Slug,news.ImageURL,news.ImagePreset,news.ImageTitle,news.ImageAlt,news.CreatedDate');

            } else {

                $this -> db -> select('news.Title,news.Description,news.Slug,news.ImageURL,news.ImagePreset,news.ImageTitle,news.ImageAlt,news.CreatedDate');
            ...
            $this -> db -> where_not_in('news.CategoriesNewsID', 3);
        ...
        function Get_most_views_news($limit = 0,$start = 0){
            ...
            if($lang == 'en'){
                ...
                $this -> db -> select('news.NewsID,news.Title_en as Title,news.Description_en as Description,news.Slug,news.ImageURL,news.ImagePreset,news.ImageTitle,news.ImageAlt,news.CreatedDate');

            } else if($lang == 'fr'){

                $this -> db -> select('news.NewsID,news.Title_fr as Title,news.Description_fr as Description,news.Slug,news.ImageURL,news.ImagePreset,news.ImageTitle,news.ImageAlt,news.CreatedDate');

            } else {

                $this -> db -> select('news.NewsID,news.Title,news.Description,news.Slug,news.ImageURL,news.ImagePreset,news.ImageTitle,news.ImageAlt,news.CreatedDate');
        ...
        function Get_hot($ParentID = false){
            ...
            if($lang == 'en'){
                ...
                $this -> db -> select('news.NewsID,news.Title,news.Description,news.Slug,news.ImageURL,news.ImagePreset,news.ImageTitle,news.ImageAlt,news.CreatedDate,news.Body');
        ...
        function Get_details($slug){
            ...
            if($lang == 'en'){
                ...
                $this -> db -> select('news.NewsID,news.Title_en as Title,news.Description_en as Description,news.Body_en as Body,news.Slug,news.CategoriesNewsID,news.SEOTitle,news.SEOKeyword,news.SEODescription,news.Hightlight,news.Tags,news.CreatedDate,news.View,news.ImageURL');

            } else if($lang == 'fr'){

                $this -> db -> select('news.NewsID,news.Title_fr as Title,news.Description_fr as Description,news.Body_fr as Body,news.Slug,news.CategoriesNewsID,news.SEOTitle,news.SEOKeyword,news.SEODescription,news.Hightlight,news.Tags,news.CreatedDate,news.View,news.ImageURL');

            } else {

                $this -> db -> select('news.NewsID,news.Title,news.Description,news.Body,news.Slug,news.CategoriesNewsID,news.SEOTitle,news.SEOKeyword,news.SEODescription,news.Hightlight,news.Tags,news.CreatedDate,news.View,news.ImageURL,news.ModifiedDate');
        ...
        function Get_pagination_news($limit, $start, $ParentID){
            ...
            if($lang == 'en'){
                ...
                $this -> db -> select('news.NewsID,news.Title_en as Title,news.Description_en as Description,news.Slug,news.ImageURL,news.ImagePreset,news.ImageTitle,news.ImageAlt,news.CreatedDate,news.View');

            } else if($lang == 'fr'){

                $this -> db -> select('news.NewsID,news.Title_fr as Title,news.Description_fr as Description,news.Slug,news.ImageURL,news.ImagePreset,news.ImageTitle,news.ImageAlt,news.CreatedDate,news.View');
        ...
        function Get_tag_pagination_news($limit, $start, $TagsID){
            ...
            if($lang == 'en'){
                ...
                $this -> db -> select('news.NewsID,news.Title,news.Description,news.Slug,news.ImageURL,news.ImagePreset,news.ImageTitle,news.ImageAlt,news.CreatedDate,news.View');
        ...
        function News_get_by_cate_id($id) {

            $this -> db -> select("Title, ImageURL, ImageTitle, ImageAlt, Slug");

            $this -> db -> from("news");

            $this -> db -> where("Publish" , 1);

            $this -> db -> where("CategoriesNewsID" , $id);
