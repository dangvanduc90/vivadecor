	...
	<main id="content" role="main" class="">
		<article class="photo-article">
			...
			<section class="ampstart-related-article-section p3 mb4 border-top border-bottom">
					<a rel="nofollow" target="_blank" title="error_404" href="<?= base_url(); ?>"><amp-img src="<?= base_url() . 'resources/ui_images/client/background/error_404.png' ?>" width="988" height="290" layout="responsive" class="mb1" alt="error_404"></amp-img></a>
			</section>
		</article>
	</main>
	<!-- Start Footer -->
