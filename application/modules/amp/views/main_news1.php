		...
		<article class="photo-article">
			...
			<section class="ampstart-related-article-section p3 mb4 border-top border-bottom">
				...
				<article class="ampstart-related-article">
						<a href="<?= base_url($news -> Slug).'.html'; ?>"><amp-img src="<?= base_url() . 'resources/uploads/images/automatic/' . $news -> ImageURL ?>" width="800" height="500" layout="responsive" alt="<?= $news -> ImageAlt ?>" attribution="<?= $news -> ImageTitle; ?>" class="mb1"></amp-img></a>
						<a href="<?= base_url($news -> Slug).'.html'; ?>"><h3 class="ampstart-heading h5 m0 mb1"><?= $news -> Title; ?></h3></a>
						<div class="entry-excerpt">
							<?= $news -> Body; ?>
						</div>
						<a href="<?= base_url($news -> Slug).'.html'; ?>" class="ampstart-rekated-article-readmore block text-decoration-none h5">Xem thêm</a>
				</article>
				<?php } }else echo "Không có tin tức nào"; ?>
				<?= $links; ?>
			</section>
			<!-- End Related article -->
		</article>
