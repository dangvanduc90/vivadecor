...
/*.mobile-share-buttons .btn-share{
...
.mobile-share-buttons .btn-share a > span{
	font-weight: bold;
}
.mobile-share-buttons .btn-share{
	-webkit-flex: 1 1 auto;
	...
	<main id="content" role="main" class="">
		<article class="photo-article">
			...
			<section class="ampstart-related-article-section p3 mb4 border-top border-bottom">
				<?php echo $breadcrumb; ?>
				<h3 class="ampstart-leading h3 m0 uppercase"><?= $product -> Title ?></h3>
				<amp-carousel width="1200"
					height="488"
					layout="responsive"
					type="slides"
					autoplay>
					<?php if ($productImage) { foreach ($productImage as $prdImage) { ?>
					<a href="#"><amp-img src="<?= base_url() ?>resources/uploads/images/automatic/san-pham/<?= $prdImage -> ImageURL ?>"
						width="1200"
						height="488"
						layout="responsive"
						alt="<?= $prdImage -> AltText; ?>"
						attribution="<?= $prdImage -> TitleText; ?>"></amp-img></a>
					<?php } } ?>
				</amp-carousel>
				<div class="lead">
...
$html = preg_replace('/(<[^>]+) style=".*?"/i', '$1', $product -> Body);
...
echo $dom->saveHTML();
		...
		<article class="photo-article">
			<!-- Start Related article -->
			<section class="ampstart-related-article-section p3 mb4 border-top border-bottom">
				<h3 class="ampstart-leading h3 m0 uppercase">Có thể bạn quan tâm</h3>
				...
				<?php if ($relative) { 
						...
						<a class="m1"
							href="<?= base_url($prd['Slug']).'.html'; ?>"
							role="listitem">
							<amp-img width="110"
							  height="110"
							  layout="responsive"
							  alt="<?= $prd['ImageAlt']; ?>"
							  src="<?= base_url() . 'resources/uploads/images/automatic/san-pham/thumbs/'. $prd['ImageURL']; ?>"></amp-img>
							<p class="relative_product_title"><?= $prd['Title']; ?></p>
						</a>
							<?php } ?>
					<?php } } ?>
				</amp-carousel>
	...
	<div class="mobile-share-buttons">
		<div class="btn-share">
			<a href="tel:<?= str_replace(array(',','.', ' '), "", $hotline[0]['Phone']) ?>">Hotline hỗ trợ: <span><?= $hotline[0]['Phone']; ?></span></a>
		</div>
	</div>
	<!-- <div class="mobile-share-buttons">
		<amp-social-share class="btn-share" type="twitter"></amp-social-share>
		<amp-social-share class="btn-share" type="facebook" data-param-app_id="792558584177374"></amp-social-share>
		<amp-social-share class="btn-share" type="gplus"></amp-social-share>
		<amp-social-share class="btn-share" type="pinterest"></amp-social-share>
		<amp-social-share class="btn-share" type="email"></amp-social-share>
	</div> -->
</body>
</html>
