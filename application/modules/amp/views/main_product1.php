	...
	<main id="content" role="main" class="">
		<article class="photo-article">
			...
			<section class="ampstart-related-article-section p3 mb4 border-top border-bottom">
				<?php echo $breadcrumb; ?>
				<h3 class="ampstart-leading h3 m0 uppercase"><?= $parent -> Title ?></h3>
		...
		<article class="photo-article">
			...
			<h3 class="ampstart-leading h3 m0 uppercase"><?= $parent -> Title ?></h3>
				<article class="ampstart-related-article">
					<amp-img src="<?= base_url() . 'resources/uploads/images/automatic/' . $parent -> ImagesURL ?>" width="397" height="177" layout="responsive" class="mb1" alt="<?= $parent -> Title ?>"></amp-img>
					<div class="mb2"><?= strip_tags($parent -> Body); ?></div>
