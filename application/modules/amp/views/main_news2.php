	...
	<main id="content" role="main" class="">
		<article class="photo-article">
			...
			<section class="ampstart-related-article-section p3 mb4 border-top border-bottom">
				<?php echo $breadcrumb; ?>
				<h3 class="ampstart-leading h3 m0 uppercase"><?= $news -> Title ?></h3>
				<div class="clear"></div>
				<div class="noi-dung">
					<strong class="label">Mô tả</strong><br />
					<?php 
					
$html = preg_replace('/(<[^>]+) style=".*?"/i', '$1', $news -> Body);
$dom = new DOMDocument();
...
echo $dom->saveHTML();
	...
	<div class="ampstart-social-box mb4">
		...
		<amp-social-share type="facebook" data-param-app_id="792558584177374"></amp-social-share>
