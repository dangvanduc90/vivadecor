<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Chỉnh sửa danh mục tin tức</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" value="<?= $category['CategoriesNewsID']?>" id="cateID">
                                <input name="cateTitle" type="text" value="<?= $category['Title']?><?php echo set_value('cateTitle'); ?>" maxlength="500" id="cateTitle" class="TextInput" onchange="checkTitle(this);" style="width:400px;">
                                <span class="tooltip">
                            ...
                            <td>
                                <select size="10" name="cateParentID" id="cateParentID" style="width:400px;">
                                    ...
                                    <?php foreach ($parentcategories as $key) :?>
                                        <option <?php if($category['ParentID'] == $key['CategoriesNewsID']) echo 'selected';?> value="<?= $key['CategoriesNewsID']?>"><?= $key['Title']?></option>
                                    <?php endforeach;?>
                                </select>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <!-- <tr>
                            <td class="key"><span class="Required">*</span>
                                &nbsp;Ảnh
                                <span class="recommend-res">(Kích thước khuyến nghị 410 x 280 pixels)</span>
                            </td>
                            <td>
                                <table id="tblUpload" cellspacing="0" cellpadding="0" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/danh-muc-tin-tuc/thumbs/<?= $category['Banner']?>">
                                                <input type="hidden" name="Banner" id="newsMainImage" value="<?= $category['Banner']?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo form_error('cateImageTitle'); ?>
                                <input name="cateImageTitle" type="text" value="<?= $category['ImageTitle']?>" maxlength="500" id="cateImageTitle" class="TextInput">
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo form_error('cateImageAlt'); ?>
                                <input name="cateImageAlt" type="text" value="<?= $category['ImageAlt']?>" maxlength="500" id="cateImageAlt" class="TextInput">
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="cateDescription" rows="2" cols="20" id="newsDescription" class="TextInput" style="height:96px;width:400px;"><?= $category['Description']?></textarea>
                            </td>
                        </tr>
                        <!-- <tr>
                            <td class="key">
                            ...
                            <td>
                                <?php echo form_error('cateBody'); ?>
                                <textarea name="cateBody" id="cateBody"><?= $category['Body']?></textarea>
                ...
                <div id="Div1">
                    <table class="admintable" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="newsPageTitle" type="text" maxlength="500" value="<?= $category['SEOTitle']?>" id="txtPageTitle" style="width:400px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="newsMetaKeywords" type="text" value="<?= $category['SEOKeyword']?>" id="txtMetaKeywords" style="width:400px;">
                                <span class="tooltip"><span class="tooltipContent">
                                    <p class="tooltiptitle">
                                        Thẻ từ khóa</p>
                                    <p class="tooltipmessage">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="newsMetaDesc" type="text" value="<?= $category['SEODescription']?>" id="txtMetaDesc" style="width:400px;">
                                <span class="tooltip"><span class="tooltipContent">
                                    <p class="tooltiptitle">
                                        Thẻ mô tả</p>
                                    <p class="tooltipmessage">
...
<script type="text/javascript">
    ...
    function checkTitle(element) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url()?>ajaxhandle/admin_news_categories_ajaxhandler/Check_Title_Except",
