<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Thêm mới ý kiến khách hàng</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <table class="admintable" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="FullName" type="text" value="" id="FullName" style="width:400px;">
                            </td>
                        </tr>
                        ...
                        <tr id="">
                            ...
                            <td>
                                ...
                                <textarea cols="60" rows="5" name="TestimonialContent" id="TestimonialContent"></textarea>
                            </td>
                        </tr>
