                ...
                <table class="admintable" width="100%">
                    <tbody>
                        ...
                        <!-- <tr>
                            ...
                            <td>
                                <?php echo form_error('prdSubCategoriesProductsID'); ?>
                            ...
                            <td>
                                ...
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        ...
                                        <p class="tooltipmessage">Diện tích sản phẩm hiển thị trên website</p>
                                    </span>
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo form_error('prdWarranty'); ?>
                                <input name="prdWarranty" type="text" id="prdWarranty" style="width:80px;">    
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="prdBody3"></textarea>
                                <script>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Màu sắc sản phẩm</p>
                                        <p class="tooltipmessage">Màu sắc chứa sản phẩm</p>
                                    </span>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Phong cách</p>
                                        <p class="tooltipmessage">Lựa chọn Phong cách</p>
                                    </span>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Phòng</p>
                                        <p class="tooltipmessage">Lựa chọn Phòng</p>
                                    </span>
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                foreach ($sections_list as $section) {
                                    echo '<input type="checkbox" id="section-' . $section['id'] . '" name="sections[]" value="' . $section['id'] . '">
