<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Thay đôi thông tin nhân lực</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="FullName" type="text" value="<?= $people['FullName']?>" maxlength="500" id="bannerTitle" class="TextInput">
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Họ tên</p>
                                        <p class="tooltipmessage">Nhập họ tên của diễn giả</p>
                                    </span>
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="FullName_en" type="text" value="<?= $people['FullName_en']?>" maxlength="500" id="bannerTitle_en" class="TextInput">
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Họ tên</p>
                                        <p class="tooltipmessage">Nhập họ tên của diễn giả</p>
                            ...
                            <td>
                                <select name="tabs_nhansu" id="tabs_nhansu" class="TextInput">
                                    <?php foreach ($tabs as $key) :?>
                                        <option <?php if($people['tabs_nhansu'] == $key['Id']) echo 'selected';?> value="<?= $key['Id']?>"><?= $key['Title']?></option>
                                    <?php endforeach;?>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Position" type="text" value="<?= $people['Position']?>" maxlength="500" id="Position" class="TextInput">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Position_en" type="text" value="<?= $people['Position_en']?>" maxlength="500" id="Position_en" class="TextInput">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/thumbs/<?= $people['ImgUrl']?>">
                                                <input type="hidden" name="ImageURL" id="ImageURL" value="<?= $people['ImgUrl']?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <img id="img_infor_upload" src="<?= base_url()?>resources/uploads/images/thumbs/<?= $people['ImgInformation']?>">
                                                <input type="hidden" name="ImgInformation" id="ImageURLinfor" value="<?= $people['ImgInformation']?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <img id="img_infor_en_upload" src="<?= base_url()?>resources/uploads/images/thumbs/<?= $people['ImgInformation_en']?>">
                                                <input type="hidden" name="ImgInformation_en" id="ImageURLinfor_en" value="<?= $people['ImgInformation_en']?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Orders" type="text" value="<?= $people['Orders']?>" id="bannerOrders" style="width:70px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="Publish" id="bannerPublish">
                                    ...
                                    <option  <?php if($people['Publish'] != 1) echo 'selected="selected"'?> value="0">Không</option>
                                </select>
                            </td>
                        </tr>
