<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Thêm mới dịch vụ</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Title_en" type="text" value="" maxlength="500" id="bannerTitle_en" class="TextInput">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="Description" rows="2" cols="20" id="newsDescription" class="TextInput" style="height:96px;width:400px;"></textarea>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="Description_en" rows="2" cols="20" id="newsDescription_en" class="TextInput" style="height:96px;width:400px;"></textarea>
                            </td>
                        </tr>
