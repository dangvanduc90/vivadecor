                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Title" type="text" value="<?= $banner['Title']?>" maxlength="500" id="bannerTitle" class="TextInput">
                                <span class="tooltip">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Link" type="text" value="<?= $banner['Link']?>" maxlength="500" id="Link" class="TextInput">
                            </td>
                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/banner/thumbs/<?= $banner['ImageURL']?>">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <textarea name="Body" rows="2" cols="20" id="bannerDescription" style="height:96px;width:400px;"><?= $banner['Body']?></textarea>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Orders" type="text" value="<?= $banner['Orders']?>" id="bannerOrders" style="width:70px;">
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="Publish" id="bannerPublish">
                                    ...
                                    <option <?php if($banner['Publish'] != 1) echo 'selected="selected"';?> value="0">Không</option>
                                </select>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                ...
                <table class="admintable" width="100%">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="lbl-key"><?php if($banner['CreatedBy'] =='') echo '<span class="lbl-key-nan">Không xác định</span>'; else echo '<span class="lbl-key">'.$banner['CreatedBy'].'</span>';?></span>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td><span class="lbl-key"><?= $banner['CreatedDate']?></span>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td><?php if($banner['ModifiedBy'] =='') echo '<span class="lbl-key">Không xác định</span>'; else echo '<span class="lbl-key">'.$banner['ModifiedBy'].'</span>';?>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td><?php if($banner['ModifiedDate'] =='') echo '<span class="lbl-key-nan">Chưa từng sửa</span>'; else echo '<span class="lbl-key">'.$banner['ModifiedDate'].'</span>';?>
                                <span class="tooltip">
                                    <span class="tooltipContent">
