<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Cập nhật hotline</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <table class="admintable" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="hotlineTitle" type="text" value="<?= $hotline['Title']?>" id="hotlineTitle" style="width:400px;">
                                <span class="tooltip">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="hotlinePhone" type="text" value="<?= $hotline['Phone']?>" id="hotlinePhone" style="width:400px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="hotlinePublish" id="hotlinePublish">
                                    ...
                                    <option <?php if(!$hotline['Publish']) echo 'selected="selected"';?> value="0">Không</option>
                                </select>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="hotlineOrders" type="text" value="<?= $hotline['Orders']?>" id="hotlineOrders" style="width:40px;">    
                                <span class="tooltip">
                                    <span class="tooltipContent">
...
<script type="text/javascript">
    ...
    $('#form-edit').submit(function() {
        ...
        if(hotlineTitle == '') {
            $("#hotlineTitle").before('<span class="error Required  ">Nội dung footer không được trống</span>');
            hasError = true;
