<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Thêm mới quận huyện</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Title" type="text" value="<?php echo set_value('Title'); ?>" maxlength="500" id="cateTitle" class="TextInput" style="width:400px;">
                            </td>
                        </tr>
                    </tbody>
                </table>
