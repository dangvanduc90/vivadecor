<div class="grid_12">
    <form method="post" action="<?= current_url();?>
        ...
        <div class="header-content">Danh sách yêu cầu gọi lại</div>
        <div class="clear"></div>
        <div class="command">
            <span>
        ...
        <div class="wrap-main-body">
            ...
            <div style="padding:1px;">
                <table class="table-view">
                    ...
                    <tbody>
                        <?php if(count($callus_list) >0 ) {?>
                            <?php $i = 1; foreach ($callus_list as $key) :?>
                            <tr id="callus<?= $key['Id']?>">
                                ...
                                <td align="center" style="width:120px;text-align:center;">
                                    <a href="<?= base_url()?>administrator/callback/edit/<?= $key['Id']?>">Chi tiết</a>|
                        ...
                        <?php }else {?>
                            <tr>
                                <td colspan="6">Chưa có yêu cầu nào cả</td>
                            </tr>
                        <?php }?></tbody>
...
<script type="text/javascript">
   ...
   function showconfirm(id,title,message,action){
    ...
    function Delete_Hotline(id) {
        $.ajax( {
            type: "POST",
            url: "<?= base_url()?>ajaxhandle/admin_ajaxhandler/Delete_callus",
            data: { id: id},
            dataType: "json",
