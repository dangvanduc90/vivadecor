<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Thêm mới phòng</div>
        <div class="clear"></div>
        <div class="command">
                ...
                <table class="admintable" width="100%">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="catePageTitle" type="text" maxlength="500" value="" id="txtPageTitle" style="width:400px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="cateMetaKeywords" type="text" value="" id="txtMetaKeywords" style="width:400px;">
                                <span class="tooltip"><span class="tooltipContent">
                                    <p class="tooltiptitle">
                                        Thẻ từ khóa</p>
                                    <p class="tooltipmessage">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea rows="2" cols="20" style="height:96px;width:400px;" name="cateMetaDesc"></textarea>
                            </td>
                        </tr>
                        <!-- <tr>
...
<script type="text/javascript">
    ...
    function checkTitle(element) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url()?>ajaxhandle/sorting_channel_ajaxhandler/Check_Title",
            data: { title: title},
            dataType: "json",
            success: function(data) {
                if(data == 0) {
