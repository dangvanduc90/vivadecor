<div class="grid_12">
	...
	<form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
		...
		<div class="header-content">Thêm mới menu</div>

		<div class="clear"></div>

		<div class="command">

			<span><a href="<?= base_url()?>administrator/menu">Quay lại danh sách</a></span>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<input name="Title" type="text" value="" maxlength="500" id="Title" class="TextInput">
						...
						<tr>
							...
							<td>
								...
								<textarea name="Description" rows="2" cols="20" id="Description" class="TextInput" style="height:96px;width:400px;"></textarea>
							...
							<td>
								...
								<span class="tooltip">
									...
									<span class="tooltipContent">
										...
										<p class="tooltipmessage">Lựa chọn để click menu ngoài website.</p>
						...
						<!-- <tr>
							...
							<td>
								...
								<input id="rdoIsStatic" type="radio" name="IsStatic" value="0"  checked="checked" onclick="ChangeStatic(0);"><label for="rdoIsStatic">&nbsp;Yes&nbsp;&nbsp;</label>

								<input id="rdoNotStatic" type="radio" name="IsStatic" value="1" onclick="ChangeStatic(1);"><label for="rdoNotStatic">&nbsp;No&nbsp;&nbsp;</label>
						...
						<tr id="tr-static-content" style="display:none;">
							...
							<td>
								...
								<textarea name="StaticContent" id="StaticContent"></textarea>
						...
						<tr id="tr-link" style="display:none;">
							...
							<td>
								...
								<div style="margin-bottom: 4px;">
									...
									<?php echo form_error('RdoCheck'); ?>

									<input id="rdoInternal" class="linktype" type="radio" name="linktype" value="Internal" onclick="ChangeLink(0);"><label for="rdoInternal">&nbsp;Trang trong&nbsp;&nbsp;</label>

									<input id="rdoExternal" class="linktype" type="radio" name="linktype" value="External" onclick="ChangeLink(1);"><label for="rdoExternal">&nbsp;Trang ngoài&nbsp;&nbsp;</label>

									<input id="rdoNewsCategories" class="linktype" type="radio" name="linktype" value="NewsCategories" onclick="ChangeLink(2);"><label for="rdoNewsCategories">&nbsp;Danh mục tin tức&nbsp;&nbsp;</label>

									<input id="rdoNews" class="linktype" type="radio" name="linktype" value="News" onclick="ChangeLink(3);"><label for="rdoNews">&nbsp;Danh sách tin tức&nbsp;&nbsp;</label>

									<input id="rdoProductCategories" class="linktype" type="radio" name="linktype" value="ProductCategories" onclick="ChangeLink(5);"><label for="rdoProductCategories">&nbsp;Danh mục sản phẩm&nbsp;&nbsp;</label>

									<input id="rdoProducts" class="linktype" type="radio" name="linktype" value="Products" onclick="ChangeLink(6);"><label for="rdoProducts">&nbsp;Danh sách sản phẩm&nbsp;&nbsp;</label>
						...
						<tr>
							...
							<td>
								...
								<select size="7" name="ParentID" id="ParentID" class="TextInput" style="width:306px;">
									...
									<option selected value="0">Gốc</option>

									<?php foreach ($parentmenu_list as $key => $value) :?>

										<option value="<?= $value['MenuID']?>"><?= $value['Title']?></option>
						...
						<tr>
							...
							<td>
								...
								<input name="Orders" type="text" value="" id="Orders" class="TextInput" style="width:50px;">
						...
						<tr>
							...
							<td>
								...
								<input id="IsNewTab" type="checkbox" name="IsNewTab" />
					...
					<table class="admintable" width="100%">
						...
						<tr>
							...
							<td>
								...
								<input name="menuPageTitle" type="text" maxlength="500" id="txtPageTitle" style="width:400px;">
						...
						<tr>
							...
							<td>
								...
								<input name="menuMetaKeywords" type="text" id="txtMetaKeywords" style="width:400px;">
						...
						<tr>
							...
							<td>
								...
								<textarea name="menuMetaDesc" id="txtMetaDesc" rows="5" style="width:400px;"></textarea>
 ...
 //<![CDATA[
	...
	function upload_images() {
		...
		$.ajaxFileUpload({
			...
			url         :"<?= base_url()?>ajaxhandle/admin_menu_ajaxhandler/imageUpload",
...
<script type="text/javascript">
 ...
 //<![CDATA[
	...
	function ChangeLink(index) {
		...
		if(index == 0) {
			...
			if(htmlduongdan == "") {
				...
				htmlduongdan = "<div id=\"Url-3\" ><b >Đường dẫn </b><input class=\"TextInput\" type=\"text\" name=\"Url\" placeholder=\"Đường dẫn\"></div>";
	...
	function ShowNewsCate() {
		...
		if(htmlLinkNewsCate == "") {
			...
			$.ajax( {
				...
				url: "<?= base_url()?>ajaxhandle/admin_menu_ajaxhandler/Get_NewsCate",
	...
	function ShowNews() {
		...
		if(htmlLinkNews == "") {
			...
			$.ajax( {
				...
				url: "<?= base_url()?>ajaxhandle/admin_menu_ajaxhandler/Get_News",
	...
	function ShowProdCate() {
		...
		if(htmlLinkProdCate == "") {
			...
			$.ajax( {
				...
				url: "<?= base_url()?>ajaxhandle/admin_menu_ajaxhandler/Get_ProdCate",
	...
	function ShowProd() {
		...
		if(htmlLinkProd == "") {
			...
			$.ajax( {
				...
				url: "<?= base_url()?>ajaxhandle/admin_menu_ajaxhandler/Get_Prod",
	...
	$('form').submit(function() {
		...
		var RdoCheck = $(".linktype:checked").size();

		if(RdoCheck == 0) {

			$("#rdoInternal").before('<div class="error Required">Link menu không được trống</div>');

			hasError = true;

			if (idElementError == "") idElementError = "RdoCheck";
	...
	jQuery(document).ready(function($) {
		...
		if(value1) {
			...
			// if($('input[id=rdoNewsCategories]').filter(':checked').val()) {

			//     ShowNewsCate();

			// }else if($('input[id=rdoProductCategories]').filter(':checked').val()) {
