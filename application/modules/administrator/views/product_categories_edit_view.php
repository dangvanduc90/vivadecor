<div class="grid_12">
    ...
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        ...
        <div class="header-content">Chỉnh sửa danh mục sản phẩm</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="hidden" value="<?= $category['CategoriesProductsID']?>" id="cateID">
                            ...
                            <td>
                                ...
                                <select size="10" name="cateParentID" id="cateParentID" style="width:400px;">
                                    ...
                                    <?php foreach ($parentcategories as $key) :?>
                                        ...
                                        <option <?php if($category['ParentID'] == $key['CategoriesProductsID']) echo 'selected';?> value="<?= $key['CategoriesProductsID']?>"><?= $key['Title']?></option>
                        ...
                        <!-- <tr>
                            ...
                            <td>
                                ...
                                <?php preg_match_all("/\[(.*?)\]/",$category['Tags'],$listOTags); ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/danh-muc-san-pham/thumbs/<?= $category['ImagesURL']?>">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <textarea name="cateDescription"><?= $category['Description']?></textarea>
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td width="45%">
                                            ...
                                            <select style="width:100%;height:184px;" name="cateSortingPrice[]" id="undo_redo2_to" multiple="multiple">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td width="45%">
                                            ...
                                            <?php $list_o_brand = explode(",",$category['SortingBrand']); ?>

                                            <select style="width:100%;height:184px;" name="from" id="undo_redo" multiple="multiple">

                                            <?php foreach ($sortingbrand as $sb) { 

                                                if(!in_array($sb['SortingBrandID'], $list_o_brand)){

                                            ?>

                                                <option value="<?= $sb['SortingBrandID'] ?>"><?= $sb['Title'] ?></option>
                                        ...
                                        <td width="45%">
                                            ...
                                            <select style="width:100%;height:184px;" name="cateSortingBrand[]" id="undo_redo_to" multiple="multiple">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td width="45%">
                                            ...
                                            <select style="width:100%;height:184px;" name="cateSortingRes[]" id="undo_redo3_to" multiple="multiple">
                                ...
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td width="45%">
                                            ...
                                            <?php $list_o_channel = explode(",",$category['SortingChannel']); ?>

                                            <select style="width:100%;height:184px;" name="from4" id="undo_redo4" multiple="multiple">

                                            <?php foreach ($sortingchannel as $sc) { 

                                                if(!in_array($sc['SortingChannelID'], $list_o_channel)){

                                            ?>

                                                <option value="<?= $sc['SortingChannelID'] ?>"><?= $sc['Title'] ?></option>
                                        ...
                                        <td width="45%">
                                            ...
                                            <select style="width:100%;height:184px;" name="cateSortingChannel[]" id="undo_redo4_to" multiple="multiple">
...
<script type="text/javascript">
    ...
    function checkTitle(element) {
        ...
        $.ajax({
            ...
            url: "<?= base_url()?>ajaxhandle/admin_products_categories_ajaxhandler/Check_Title_Except",
