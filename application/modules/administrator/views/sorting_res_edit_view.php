<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Chỉnh sửa phong cách</div>
        <div class="clear"></div>
        <div class="command">
            <span><a href="<?= base_url()?>administrator/sorting/res">Quay lại danh sách</a></span>
                ...
                <table class="admintable" width="100%">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" value="<?= $category['SortingResID']?>" id="cateID">
                            ...
                            <td>
                                <select size="10" name="cateParentID" id="cateParentID" style="width:400px;">
                                    ...
                                    <?php foreach ($parentcategories as $key) :?>
                                        <option <?php if($category['ParentID'] == $key['SortingResID']) echo 'selected';?> value="<?= $key['SortingResID']?>"><?= $key['Title']?></option>
                                    <?php endforeach;?>
                                </select>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                            ...
                            <td>
                                <table id="tblUpload" cellspacing="0" cellpadding="0" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/danh-muc-do-phan-giai/thumbs/<?= $category['ImagesURL']?>">
...
<script type="text/javascript">
 //<![CDATA[
    ...
    function upload_images() {
         $.ajaxFileUpload({
            url         :"<?= base_url()?>ajaxhandle/sorting_res_ajaxhandler/imageUpload",
            secureuri      :false,
...
<script type="text/javascript">
    ...
    function checkTitle(element) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url()?>ajaxhandle/sorting_res_ajaxhandler/Check_Title_Except",
