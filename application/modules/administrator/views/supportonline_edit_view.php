<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Thêm mới hỗ trợ trực tuyến</div>
        <div class="clear"></div>
        <div class="command">
                        ...
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input name="supportTitle" type="text" value="<?= $support['Title']?>" id="supportTitle" style="width:400px;">
                                    <span class="tooltip">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="supportName" type="text" value="<?= $support['FullName']?>" id="supportName" style="width:400px;">
                                    <span class="tooltip">
                                        <span class="tooltipContent">
                                            <p class="tooltiptitle">
                                                Họ tên
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input name="supportPhone" type="text" value="<?= $support['Phone']?>" id="supportPhone" style="width:400px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input name="supportEmail" type="text" value="<?= $support['Email']?>" id="supportEmail" style="width:400px;">
                                    <span class="tooltip"><span class="tooltipContent">
                                        <p class="tooltiptitle">
                                            Email</p>
                                        <p class="tooltipmessage">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="supportSkype" type="text" value="<?= $support['Skype']?>" id="supportSkype" style="width:400px;">
                                    <span class="tooltip"><span class="tooltipContent">
                                        <p class="tooltiptitle">
                                            Skype</p>
                                        <p class="tooltipmessage">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="supportYahoo" type="text" value="<?= $support['Yahoo']?>" id="supportYahoo" style="width:400px;">
                                    <span class="tooltip"><span class="tooltipContent">
                                        <p class="tooltiptitle">
                                            Yahoo</p>
                                        <p class="tooltipmessage">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="supportPublish" id="supportPublish">
                                        ...
                                        <option <?php if($support['Publish'] != 1) echo 'selected="selected"';?> value="0">Không</option>
                                    </select>
                                    <span class="tooltip">
                                        <span class="tooltipContent">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input name="supportOrders" type="text" value="<?= $support['Orders']?>" id="supportOrders" style="width:40px;">    
                                    <span class="tooltip">
                                        <span class="tooltipContent">
