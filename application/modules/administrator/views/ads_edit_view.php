<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Cập nhật quảng cáo</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Title" type="text" value="<?= $ads['Title']?>" maxlength="500" id="adsTitle" class="TextInput">
                                <span class="tooltip">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Link" type="text" value="<?= $ads['Link']?>" maxlength="500" id="adsTitle" class="TextInput">
                            </td>
                        </tr>
                            ...
                            <td>
                                ...
                                <table id="tblUpload" cellspacing="0" cellpadding="0" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/quang-cao/thumbs/<?= $ads['ImageURL']?>">
                                                <input type="hidden" name="ImageURL" id="ImageURL" value="<?= $ads['ImageURL']?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <textarea name="Description" rows="2" cols="20" id="adsDescription" style="height:96px;width:400px;"><?= $ads['Description']?></textarea>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <select size="10" name="AdsGroupsID" id="ddlCate" style="width:400px;">
                                  <?php foreach ($adsgroups_list as $key) :?>
                                      <option value="<?= $key['AdsGroupsID']?>" <?php if($ads['AdsGroupsID'] == $key['AdsGroupsID']) echo 'selected="selected"' ?>><?= $key['Title']?></option>
                                  <?php endforeach;?>
                                </select>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Height" type="text" value="<?= $ads['Height']?>" id="adsHeight" style="width:70px;">
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Width" type="text" value="<?= $ads['Width']?>" id="adsWidth" style="width:70px;">
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Orders" type="text" value="<?= $ads['Orders']?>" id="adsOrders" style="width:70px;">
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="Publish" id="adsPublish">
                                    ...
                                    <option <?php if($ads['Publish'] != 1) echo 'selected="selected"';?> value="0">Không</option>
                                </select>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                ...
                <table class="admintable" width="100%">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="lbl-key"><?php if($ads['CreatedBy'] =='') echo '<span class="lbl-key-nan">Không xác định</span>'; else echo '<span class="lbl-key">'.$ads['CreatedBy'].'</span>';?></span>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td><span class="lbl-key"><?= $ads['CreatedDate']?></span>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td><?php if($ads['ModifiedBy'] =='') echo '<span class="lbl-key">Không xác định</span>'; else echo '<span class="lbl-key">'.$ads['ModifiedBy'].'</span>';?>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td><?php if($ads['ModifiedDate'] =='') echo '<span class="lbl-key-nan">Chưa từng sửa</span>'; else echo '<span class="lbl-key">'.$ads['ModifiedDate'].'</span>';?>
                                <span class="tooltip">
                                    <span class="tooltipContent">
