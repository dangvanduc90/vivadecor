<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Thay đổi thông tin đối tác</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Title" type="text" value="<?= $partner['Title']?>" style="width:400px;" maxlength="500" id="partnersTitle" >
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="key"><span class="Required">*</span>
                                &nbsp;Logo
                                <span class="recommend-res">(Kích thước khuyến nghị 160x80 pixels)</span>
                            </td>
                            <td>
                                <table id="tblUpload" cellspacing="0" cellpadding="0" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/logo/thumbs/<?= $partner['ImageUrl']?>">
                                                <input type="hidden" name="ImageUrl" id="ImageURL" value="<?= $partner['ImageUrl']?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Url" type="text" value="<?= $partner['Url']?>" style="width:400px;" maxlength="500" id="partnersLink" >
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="Publish" id="partnersPublish">
                                    ...
                                    <option <?php if($partner['Publish'] != 1) echo 'selected="selected"';?> value="0">Không</option>
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo form_error('partnersOrders'); ?>
                                <input name="Orders" type="text" value="<?= $partner['Orders']?>" id="partnersOrders" style="width:70px;">
                            </td>
                        </tr>
...
<script type="text/javascript">
    ...
    $('form#form-edit').submit(function() {
        ...
        var partnersTitle_en = $("#partnersTitle_en").val();
        if(partnersTitle_en == '') {
            $("#partnersTitle_en").before('<div class="error Required">Tên đối tác tiếng anh không được trống</div>');
            hasError = true;
            if (idElementError == "") idElementError = "partnersTitle_en";
        }
