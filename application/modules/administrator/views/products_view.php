              ...
              <?php if(count($products_list) > 0 ) {?>  
  	        		...
  	        		<?php $i = 1; foreach ($products_list as $key) :?>
  		        		...
  		        		<tr id="Row<?= $key['ProductsID']?>">
  		        			...
  		        			<td align="center" style="width:60px;text-align:center;"><img src="<?= base_url()?>resources/uploads/images/automatic/san-pham/thumbs/<?= $key['ImageURL']?>" height="30" width="50"/></td>
                    ...
                    <td align="center" style="width:150px;text-align:center;"><a href="<?= base_url()?>administrator/products/edit/<?= $key['ProductsID']?>">Chỉnh sửa</a> | <a href="javascript:void(0);" onclick="showconfirm(<?= $key['ProductsID']?>,'Xác thực xóa sản phẩm','Bạn có chắc muốn xóa sản phẩm này?','delete');">xóa</a></td>
    ...
    $.ajax( {
          ...
          success: function(data) {
            ...
            if(data == 0) {
              ...
              notice("Đã cập nhật trạng thái hoàn thành cho sản phẩm.");
