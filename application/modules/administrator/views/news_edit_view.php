<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Chỉnh sửa tin tức</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="newsTitle" type="text" value="<?= $news['Title']?>" maxlength="500" id="newsTitle" class="TextInput" onchange="checkTitle(this);">
                                <span class="tooltip">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php preg_match_all("/\[(.*?)\]/",$news['Tags'],$listOTags); ?>
                                <ul id="newsTags">
                        ...
                        <tr>
                            <td class="key"><span class="Required">*</span>
                                &nbsp;Ảnh chính
                                <span class="recommend-res">(Kích thước đề nghị 307 x 187 pixels)</span>
                            <td>
                                <table id="tblUpload" cellspacing="0" cellpadding="0" width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/tin-tuc/thumbs/<?= $news['ImageURL']?>">
...
<script type="text/javascript">
    ...
    function checkTitle(element) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url()?>ajaxhandle/admin_news_ajaxhandler/Check_Title_Except",
