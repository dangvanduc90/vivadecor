<div class="grid_12">
    ...
    <div class="header-content">Danh sách phòng</div>
                ...
                <tbody>
                    ...
                    <?php $i = 1; foreach ($category_list as $key) :?>
                        ...
                        <tr id="Row<?= $key['SortingChannelID']?>">
                            ...
                            <td align="center" style="width:150px;text-align:center;"><a href="<?= base_url()?>administrator/sorting/channel/edit/<?= $key['SortingChannelID']?>">Chỉnh sửa</a> | <a href="javascript:void(0);" onclick="showconfirm(<?= $key['SortingChannelID']?>,'Xác thực xóa danh mục','Xóa danh mục đồng nghĩa với việc xóa tất cả tin bán sản phẩm thuộc danh mục này.<br/><br/>Bạn có chắc muốn xóa danh mục tin này?','delete')">xóa</a></td>
