<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Chỉnh sửa footer</div>
        <div class="clear"></div>
        <div class="command">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Title" type="text" value="<?= $footer['Title']?>" maxlength="500" id="footerTitle" class="TextInput">
                                <span class="tooltip">
                        ...
                        <!-- <tr>
                            ...
                            <td>
                                ...
                                <input name="Link" type="text" value="<?= $footer['Link']?>" maxlength="500" id="Link" class="TextInput">
                            </td>
                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/footer/thumbs/<?= $footer['ImageURL']?>">
                                                <input type="hidden" name="ImageURL" id="ImageURL" value="<?= $footer['ImageURL']?>">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <textarea name="Body" id="Body"><?= $footer['Body']?></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="Orders" type="text" value="<?= $footer['Orders']?>" id="footerOrders" style="width:70px;">
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="Publish" id="footerPublish">
                                    ...
                                    <option <?php if($footer['Publish'] != 1) echo 'selected="selected"';?> value="0">Không</option>
                                </select>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                ...
                <table class="admintable" width="100%">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="lbl-key"><?php if($footer['CreatedBy'] =='') echo '<span class="lbl-key-nan">Không xác định</span>'; else echo '<span class="lbl-key">'.$footer['CreatedBy'].'</span>';?></span>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Người khởi tạo</p>
                                        <p class="tooltipmessage">Tên tài khoản của người đã tạo ra footer này</p>
                                    </span>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><span class="lbl-key"><?= $footer['CreatedDate']?></span>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Ngày khởi tạo</p>
                                        <p class="tooltipmessage">Ngày giờ footer được khởi tạo</p>
                                    </span>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><?php if($footer['ModifiedBy'] =='') echo '<span class="lbl-key">Không xác định</span>'; else echo '<span class="lbl-key">'.$footer['ModifiedBy'].'</span>';?>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Người chỉnh sửa</p>
                                        <p class="tooltipmessage">Tên tài khoản của người đã chỉnh sửa footer này</p>
                                    </span>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><?php if($footer['ModifiedDate'] =='') echo '<span class="lbl-key-nan">Chưa từng sửa</span>'; else echo '<span class="lbl-key">'.$footer['ModifiedDate'].'</span>';?>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Ngày chỉnh sửa</p>
                                        <p class="tooltipmessage">Ngày giờ footer được chỉnh sửa</p>
                                    </span>
                                </span>
                            </td>
                        </tr>
