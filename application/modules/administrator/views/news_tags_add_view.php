<div class="grid_12">
    <form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Thêm mới tag tin tức</div>
        <div class="clear"></div>
        <div class="command">
            <span><a href="<?= base_url()?>administrator/newstags">Quay lại danh sách</a></span>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="tagsTitle" type="text" value="<?php echo set_value('tagsTitle'); ?>" maxlength="500" id="cateTitle" class="TextInput" style="width:400px;"/>
                                <span class="tooltip">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="tagsOrders" type="text" value="" id="tagsOrders" style="width:40px;"/>
                                <span class="tooltip">
                                    <span class="tooltipContent">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="tagsDescription" rows="2" cols="20" id="tagsDescription" class="TextInput" style="height:96px;width:400px;"></textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div id="Div1">
                    <table class="admintable" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="tagsPageTitle" type="text" maxlength="500" id="txtPageTitle" style="width:400px;"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="tagsMetaKeywords" type="text" id="txtMetaKeywords" style="width:400px;"/>
                                <span class="tooltip"><span class="tooltipContent">
                                    <p class="tooltiptitle">
                                        Thẻ từ khóa</p>
                                    <p class="tooltipmessage">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="tagsMetaDesc" id="txtMetaDesc" rows="5" style="width:400px;"></textarea>
                                <span class="tooltip"><span class="tooltipContent">
                                    <p class="tooltiptitle">
                                        Thẻ mô tả</p>
                                    <p class="tooltipmessage">
