<div class="grid_12">
    <form method="post" action="<?= current_url(); ?>" name="form-edit" id="form-edit" accept-charset="utf-8">
        <div class="header-content">Chỉnh sửa sản phẩm</div>
        <div class="clear"></div>
        <div class="command">
        ...
        <div id="tabs">
            ...
            <div id="tabs-1">
                <table class="admintable" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" value="<?= $product['ProductsID'] ?>" id="prdID">
                            <?php echo form_error('prdTitle'); ?>
                            <input name="prdTitle" type="text"
                                   value="<?= $product['Title'] ?><?php echo set_value('prdTitle'); ?>" maxlength="500"
                                   id="prdTitle" class="TextInput" style="width:400px;" onchange="checkTitle(this);">
                        </td>
                    </tr>
                    <!-- <tr>
                            <td class="key" style="width: 150px;">
                    ...
                    <tr>
                        ...
                        <td>
                            <select size="10" name="prdCategoriesProductsID" id="prdCategoriesProductsID"
                                    style="width:400px;">
                                <?php foreach ($categories_list as $key) : ?>
                                    <option <?php if ($product['CategoriesProductsID'] == $key['CategoriesProductsID']) echo 'selected'; ?>
                                            value="<?= $key['CategoriesProductsID'] ?>"><?= $key['Title'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                    <!-- <tr>
                            ...
                            <td>
                                <select size="10" multiple name="prdSubCategoriesProductsID[]" id="prdSubCategoriesProductsID" style="width:400px;">
                                    <?php $listOSub = explode(",", $product['SubCategoriesProductsID']) ?>
                                    <?php foreach ($categories_list as $key) : ?>
                                        <option <?php foreach ($listOSub as $los) {
                        if ($los == $key['CategoriesProductsID']) echo 'selected';
                    } ?> value="<?= $key['CategoriesProductsID'] ?>"><?= $key['Title'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </td>
                    ...
                    <!-- <tr>
                            ...
                            <td>
                                <?php preg_match_all("/\[(.*?)\]/", $product['Tags'], $listOTags); ?>
                                <ul id="prdTags">
                                    <?php foreach ($tags as $key) {
                        if (in_array($key['TagsID'], $listOTags[1])) { ?>
                                        <li><?= $key['Title'] ?></li>
                                    <?php }
                    } ?>
                                </ul>
                    ...
                    <tr>
                        <td class="key"><span class="Required">*</span>
                            &nbsp;Ảnh chính
                            <span class="recommend-res">(Kích thước đề nghị 396 x 177 pixels)</span>
                        <td>
                            <table id="tblUpload" cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr>
                                    <td>
                                        <img id="img_upload"
                                             src="<?= base_url() ?>resources/uploads/images/automatic/san-pham/thumbs/<?= $product['ImageURL'] ?>">
                                        <input type="hidden" name="prdMainImage" id="prdMainImage"
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <a onclick="showconfirm('','Xác thực Upload ảnh','Bạn muốn upload hình ảnh này?','uploadimgmain');"
                                           class="linkbtn">Upload</a>
                                        <span class="tooltip">
                                                    <span class="tooltipContent">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="prdImageTitle" type="text" value="<?= $product['ImageTitle'] ?>"
                                   maxlength="500" id="prdImageTitle" class="TextInput">
                            <span class="tooltip">
                                    <span class="tooltipContent">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="prdImageAlt" type="text" value="<?= $product['ImageAlt'] ?>" maxlength="500"
                                   id="prdImageAlt" class="TextInput">
                            <span class="tooltip">
                                    <span class="tooltipContent">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="prdPublish" id="prdPublish">
                                ...
                                <option <?php if ($product['Publish'] != 1) echo 'selected="selected"'; ?> value="0">
                                    Không
                                </option>
                            </select>
                            <span class="tooltip">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="prdOrders" type="text" value="<?= $product['Orders'] ?>" id="prdOrders"
                                   style="width:40px;">
                            <span class="tooltip">
                                    <span class="tooltipContent">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input name="prdSellPrice" type="text"
                                   value="<?= $product['SellPrice'] ?><?php echo set_value('prdSellPrice'); ?>"
                                   id="prdSellPrice" style="width:120px;">
                            <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Diện tích sản phẩm</p>
                                        <p class="tooltipmessage">Diện tích bán của sản phẩm hiển thị trên website</p>
                                    </span>
                                </span>
                        </td>
                    </tr>
                    <!-- <tr>
                        ...
                        <tr>
                            <td class="key">Bảo hành</td>
                            <td>
                                <input name="prdWarranty" type="text" value="<?= $product['Warranty'] ?><?php echo set_value('prdWarranty'); ?>" id="prdWarranty" style="width:120px;">
                                <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Bảo hành</p>
                                        <p class="tooltipmessage">Thời gian bảo hành của sản phẩm</p>
                                    </span>
                                </span>
                            </td>
                        </tr> -->
                    ...
                    <tr>
                        <td class="key">Chi tiết sản phẩm</td>
                        <td>
                    ...
                    <!-- <tr>
                            <td class="key">Thông số kỹ thuật</td>
                            <td>
                                <textarea name="prdBody2"><?= $product['Body2'] ?></textarea>
                                <script>
                        ...
                        <tr>
                            <td class="key">Chương trình khuyến mãi</td>
                            <td>
                                <textarea name="prdBody3"><?= $product['Body3'] ?></textarea>
                                <script>
                                    CKEDITOR.replace('prdBody3',{language: 'vi',});
                                </script>
                            </td>
                        </tr> -->
                    </tbody>
            ...
            <div id="tabs-5">
                <table class="admintable" width="100%">
                        ...
                        <td>
                            <select size="10" name="prdSortingBrandID" id="prdSortingBrandID" style="width:400px;">
                                <?php foreach ($brand_list as $key) : ?>
                                    <option <?php if ($product['SortingBrandID'] == $key['SortingBrandID']) echo 'selected'; ?>
                                            value="<?= $key['SortingBrandID'] ?>"><?= $key['Title'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                        ...
                        <td>
                            <select size="10" name="prdSortingResID" id="prdSortingResID" style="width:400px;">
                                <?php foreach ($res_list as $key) : ?>
                                    <option <?php if ($product['SortingResID'] == $key['SortingResID']) echo 'selected'; ?>
                                            value="<?= $key['SortingResID'] ?>"><?= $key['Title'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                        ...
                        <td>
                            <select size="10" name="prdSortingChannelID" id="prdSortingChannelID" style="width:400px;">
                                <?php foreach ($channel_list as $key) : ?>
                                    <option <?php if ($product['SortingChannelID'] == $key['SortingChannelID']) echo 'selected'; ?>
                                            value="<?= $key['SortingChannelID'] ?>"><?= $key['Title'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php echo form_error('prdSortingPriceID'); ?>
                            <select size="10" name="prdSortingPriceID" id="prdSortingPriceID" style="width:400px;">
                                <?php foreach ($price_list as $key) : ?>
                                    <option <?php if ($product['SortingPriceID'] == $key['SortingPriceID']) echo 'selected'; ?>
                                            value="<?= $key['SortingPriceID'] ?>"><?= $key['Title'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <span class="tooltip">
                                    <span class="tooltipContent">
                                        <p class="tooltiptitle">Diện tích</p>
                                        <p class="tooltipmessage">Lựa chọn Diện tích</p>
                                    </span>
                                </span>
                        </td>
                    </tr>
            ...
            <div id="tabs-2">
                <label style="display:inline-block;width:60px;">Thẻ Title</label><input type="text" name="TitleText"
                                                                                        id="TitleText"
                                                                                        style="width:400px;"><br/><br/>
                <label style="display:inline-block;width:60px;">Thẻ Alt</label><input type="text" name="AltText"
                                                                                      id="AltText" style="width:400px;"><br/><br/>
                <span class="recommend-res">(Kích thước đề nghị tối thiểu 800x800 px)</span>
                <input type="file" name="userfile2" id="userfile2" size="20"/>
                <a onclick="showconfirm('','Xác thực Upload ảnh','Bạn muốn upload hình ảnh này?','uploadimg');"
                   class="linkbtn">Upload</a>
                                ...
                                <tr id="image-item<?= $key['ImageProductsID'] ?>">
                                    ...
                                    <td style="width:130px;text-align:center;">
                                        <img width="125px" height="100px"
                                             src="<?= base_url() ?>resources/uploads/images/automatic/san-pham/thumbs/<?= $key['ImageURL'] ?>"
                                             alt=""/>
                                    </td>
                                    <td>
                                        <?= $key['TitleText'] ?>
                                    ...
                                    <td style="width:70px;text-align:center;">
                                        <input name="txtPositionNum" type="text"
                                               id="txtPositionNum<?= $key['ImageProductsID'] ?>"
                                               value="<?= $key['Orders'] ?>"
                                               onchange="update_order_image(<?= $key['ImageProductsID'] ?>,this);"
                                               style="width:60px;">
                                    </td>
                                    <td style="width:100px;text-align:center;">
                                        <input type="radio" <?php if ($key['IsMainImage'] == 1) echo "checked"; ?>
                                               name="mainimage" value=""
                                               onchange="update_main_image(<?= $key['ImageProductsID'] ?>);"
                                               placeholder=""/>
                                    </td>
                                    <td style="width:100px;text-align:center;">
            ...
            <div id="tabs-3">
                <table class="admintable" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="prdIsHot" type="checkbox" <?php if ($product['IsHot'] == 1) echo "checked"; ?>
                                   name="prdIsHot">
                        ...
                        <!-- <td>
                                ...
                                <label for="prdIsStock">Hoàn thành</label>
                            </td> -->
                    </tr>
                    <tr>
                        <td class="key">Hiển thị ở section trang chủ</td>
                        <td>
                            <?php
                            $section_ids = array_map(function ($item) {
                                return $item['section_id'];
                            }, $sections_by_product_id);

                            foreach ($sections_list as $section) {
                                $checked = in_array($section['id'], $section_ids) ? 'checked' : '';
                                echo '<input type="checkbox" '.$checked.' id="section-' . $section['id'] . '" name="sections[]" value="' . $section['id'] . '">
                ...
                <div id="Div1">
                    <table class="admintable" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="prdPageTitle" type="text" maxlength="500"
                                       value="<?= $product['SEOTitle'] ?>" id="txtPageTitle" style="width:400px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input name="prdMetaKeywords" type="text" id="txtMetaKeywords"
                                       value="<?= $product['SEOKeyword'] ?>" style="width:400px;">
                                <span class="tooltip"><span class="tooltipContent">
                                    <p class="tooltiptitle">
                                        Thẻ từ khóa</p>
                                    <p class="tooltipmessage">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea name="prdMetaDesc" id="txtMetaDesc" rows="5"
                                          style="width:400px;"><?= $product['SEODescription'] ?></textarea>
                                <span class="tooltip"><span class="tooltipContent">
                                    <p class="tooltiptitle">
                                        Thẻ mô tả</p>
                                    <p class="tooltipmessage">
...
<script type="text/javascript">
    ...
    $('form').submit(function () {
        ...
        if (!$("#prdSortingBrandID option:selected").length) {
            $("#prdSortingBrandID").before('<div class="error Required">Màu sắc sản phẩm phải được chọn</div>');
            hasError = true;
        ...
        if (isNaN(prdSellPrice)) {
            $("#prdSellPrice").before('<span class="error Required  ">Diện tích sản phẩm phải là các chữ số</span>');
            hasError = true;
    ...
    function checkTitle(element) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url()?>ajaxhandle/admin_products_ajaxhandler/Check_Title_Except",
