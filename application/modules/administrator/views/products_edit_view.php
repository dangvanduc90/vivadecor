                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="prdTitle" type="text" value="<?= $product['Title']?><?php echo set_value('prdTitle'); ?>" maxlength="500" id="prdTitle" class="TextInput" style="width:400px;" onchange="checkTitle(this);">
                            ...
                            <td>
                                ...
                                <select size="10" multiple name="prdSubCategoriesProductsID[]" id="prdSubCategoriesProductsID" style="width:400px;">
                                    ...
                                    <?php foreach ($categories_list as $key) :?>
                                        ...
                                        <option <?php foreach($listOSub as $los){ if($los == $key['CategoriesProductsID']) echo 'selected'; } ?> value="<?= $key['CategoriesProductsID']?>"><?= $key['Title']?></option>
                        ...
                        <!-- <tr>
                            ...
                            <td>
                                ...
                                <ul id="prdTags">
                                    ...
                                    <?php foreach ($tags as $key) { if (in_array($key['TagsID'], $listOTags[1])) { ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/san-pham/thumbs/<?= $product['ImageURL']?>">
                            ...
                            <td>
                                ...
                                <select size="10" name="prdSortingPriceID" id="prdSortingPriceID" style="width:400px;">
                                    ...
                                    <?php foreach ($price_list as $key) :?>
                                        ...
                                        <option <?php if($product['SortingPriceID'] == $key['SortingPriceID']) echo 'selected';?> value="<?= $key['SortingPriceID']?>"><?= $key['Title']?></option>
                                ...
                                <?php $i = 1; foreach ($images as $key) :?>
                                    ...
                                    <tr id="image-item<?= $key['ImageProductsID']?>">
                                        ...
                                        <td style="width:130px;text-align:center;">
                                            ...
                                            <img width="125px" height="100px" src="<?= base_url()?>resources/uploads/images/automatic/san-pham/thumbs/<?= $key['ImageURL']?>" alt="" />
