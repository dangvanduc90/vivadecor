<div class="grid_12">
	...
	<form method="post" action="<?= current_url();?>" name="form-edit" id="form-edit" accept-charset="utf-8">
		...
		<div class="header-content">Cập nhật menu</div>
					...
					<tbody>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img id="img_upload" src="<?= base_url()?>resources/uploads/images/automatic/menu/thumbs/<?= $menu['ImageURL']?>">

                                                <input type="hidden" name="prdMainImage" id="prdMainImage" value="<?= $menu['ImageURL']?>">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="prdImageTitle" type="text" value="<?= $menu['ImageTitle']?>" maxlength="500" id="prdImageTitle" class="TextInput">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input name="prdImageAlt" type="text" value="<?= $menu['ImageAlt']?>" maxlength="500" id="prdImageAlt" class="TextInput">
