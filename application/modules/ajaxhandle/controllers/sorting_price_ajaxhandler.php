<?php
    ...
    class Sorting_price_ajaxhandler extends CMS_AdminController {
        ...
        function Update_Orders() {
            $result = $this -> sorting_price_model -> Ajax_Update_Orders();
            $a = '';
            $result ? $a = '1' : $a = '0';
            echo json_encode($a);
        }
        ...
        function Check_Title() {
            ...
            $result = $this -> sorting_price_model -> Ajax_Check_Title();
        ...
        function Check_Title_Except() {
            ...
            $result = $this -> sorting_price_model -> Ajax_Check_Title_Except();
